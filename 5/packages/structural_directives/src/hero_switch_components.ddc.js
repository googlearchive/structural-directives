define(['dart_sdk', 'packages/structural_directives/src/hero'], function(dart_sdk, hero) {
  ...
  dart.trackLibraries("packages/structural_directives/src/hero_switch_components.ddc", {
    "package:structural_directives/src/hero_switch_components.dart": src__hero_switch_components
