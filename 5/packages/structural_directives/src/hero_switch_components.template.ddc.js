define(['dart_sdk', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/constants', 'packages/angular/src/core/metadata/view', 'packages/angular/src/core/linker/app_view_utils', 'packages/structural_directives/src/hero_switch_components', 'packages/angular/src/core/linker/app_view', 'packages/angular/src/di/reflector', 'packages/structural_directives/src/hero.template', 'packages/angular/angular.template'], function(dart_sdk, view_type, constants, view, app_view_utils, hero_switch_components, app_view, reflector, hero, angular) {
  'use strict';
  ...
  dart.trackLibraries("packages/structural_directives/src/hero_switch_components.template.ddc", {
    "package:structural_directives/src/hero_switch_components.template.dart": src__hero_switch_components$46template
